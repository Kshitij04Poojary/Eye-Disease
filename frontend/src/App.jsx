      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="flex-1 space-y-6 p-6 ">
          <Routes>
            ...
            <Route
              path="/consultation"
              element={user ? <ConsultationRoom user={user} /> : <Navigate to="/login" />}
            />
            <Route path="/userBookings" element={<UserBookings />} />
            <Route path="/doctorAvailability" element={<DoctorAvailability />} />
            <Route path="/profile" element={<ProtectedRoute element={<DoctorProfile />} allowedRoles={["Doctor"]} />} />
            <Route path="/getAllDoctors" element={<ProtectedRoute element={<DoctorsList />} allowedRoles={["Patient"]} />} />
            <Route path="/health" element={<ProtectedRoute element={<HealthMetricsProfile />} allowedRoles={["Patient"]} />} />
            <Route path="/chatbot" element={<ProtectedRoute element={<Chatbot />} allowedRoles={["Patient"]} />} />
            <Route path="/dashboard" element={<ProtectedRoute element={<Dashboard />} allowedRoles={["Doctor"]} />} />
